...
template<class ProjectManager> ProjectManager* Mgr<ProjectManager>::instance = nullptr;
template<class ProjectManager> bool  Mgr<ProjectManager>::isShutdown = false;
